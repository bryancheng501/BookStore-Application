...
function loadBooks(books){
    ...
    if (books.length > 0){
        ...
        document.getElementById('orderDiv').style.display = 'hidden'
    }   else{
        document.getElementById('checkoutDiv').style.display = 'hidden'
    }
...
function loadOrder(books){
    let div = document.getElementById('orderDiv')
    div.style.display = 'block'
    document.getElementById('checkoutDiv').style.display = 'none'
    document.getElementById('books').innerHTML = ''

    booksDiv = document.getElementById('booksInOrder')
    //Display books generated by search
    for (let i = 0; i < books.length; i++){
        //make html for all the book info
        let title = document.createElement('label')
